...
import { UserPlus, Trash2, Phone, Mail, Star, AlertTriangle, Search, Loader2 } from "lucide-react";
...
export const EmergencyContacts = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Add New Contact - Search Registered Users */}
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            <UserPlus className="h-5 w-5" />
            Add Emergency Contact (Registered Users Only)
          </CardTitle>
        </CardHeader>
        ...
        <CardContent>
          {contacts.length === 0 ? (
            <p className="text-muted-foreground text-center py-8">
              No emergency contacts added yet. Search for registered users above to add them.
            </p>
          ) : (
